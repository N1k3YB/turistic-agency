...
```mermaid
pie title Распределение по ролям
    "USER" : 40
    "MANAGER" : 25
    "ADMIN" : 35
```
...
```bash
git clone https://github.com/n1keyb/turistic-agency.git
cd turistic-agency
```
...
```
# База данных
DATABASE_URL="postgresql://username:password@localhost:5432/aviaways"
