  ...
  return (
    <div className="bg-gray-50 min-h-screen py-10">
      <div className="container mx-auto px-4 max-w-5xl">
        ...
        <h1 className="text-3xl font-bold text-gray-800 mb-8">Редактирование тура: {originalData?.title}</h1>
        
        {originalData?._count?.orders && originalData._count.orders > 0 && (
            ...
            <div className="flex">
              ...
              <div className="ml-3">
                <p className="text-sm text-yellow-700">
                  <strong>Внимание:</strong> У этого тура есть {originalData._count.orders} заказ(ов). Изменение названия или URL может повлиять на существующие заказы.
                </p>
              </div>
            </div>
          </div>
